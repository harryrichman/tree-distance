...
We use the fact that a nontrivial submatrix $D[S]$ of a distance matrix has nonzero determinant.
...
however, the same argument applies to a weighted distance matrix by applying Bapat--Kirkland--Neumann's result on the weighted distance matrix determinant \cite{bapat-kirkland-neumann}. 
\end{proof}
...
(b) This follows form (a), since the determinant is the product of eigenvalues.
\end{proof}
