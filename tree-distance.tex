...
This graph has $7$ edges and $21$ $S$-rooted spanning forests.
...
There is also a weighted version, see \eqref{eq:w-distance-inverse}.
...
\begin{eg}
Suppose $G$ is the tree with edge weights shown below, with four leaf vertices and two internal vertices.
\begin{figure}[h]
\centering
\begin{tikzpicture}
	\coordinate (1) at (-2,0.7);
