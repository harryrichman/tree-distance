...
\end{thm}
\begin{proof}
See Tutte~\cite[Section VI.6, Equation (VI.6.7)]{tutte} or Chaiken~\cite{chaiken}
\end{proof}
...
\begin{thm}[{Distance matrix cofactor sums \cite[Theorem 11]{bapat-sivasubramanian}}]
Given a tree $G$,
...
\begin{proof}
See Bapat--Sivasubramanian~\cite[Theorem 11]{bapat-sivasubramanian}.
\end{proof}
