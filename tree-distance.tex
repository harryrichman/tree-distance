...
\begin{align}
  ...
  &= \sum_{T\in \trees} w(T) \sum_{e\in E} \alpha_e \left( \sum_{s \in S} (2 - \deg^o(T, s)) \delta(e; v,s) \right) \\
  &= \sum_{T \in \trees} w(T) \sum_{e \in E} \alpha_e \left( \sum_{s \in S \cap (G\setminus e)^{\overline v}} (2 - \deg^o(T, s)) \right) \\
  &= \sum_{T \in \trees} w(T) \sum_{e \in E} \alpha_e \left( \sum_{s \in S \cap (G\setminus e)^{\overline v}} \sum_{w \in T(s)} (2 - \deg(w)) \right). \label{eq:14-1}
\end{align}
where
\[ 
...
\[
	\bigcup_{s \in S \cap (G\setminus e)^{\overline v}} \{ w \in T(s)\} = \begin{cases}
	\displaystyle
...
1 &\text{if }e \not \in T, \\
1 - (2 - \degout(T \setminus e, *)) &\text{if } e \in T(s_0),\, s_0 \in S(G\setminus e)^{\overline v} , \\
1 + (2 - \degout(T \setminus e, *)) &\text{if } e \in T(s_0),\, s_0 \in S(G\setminus e)^v
\end{cases}
\end{align*}
...
observing that the deletion $T \setminus e$ is an $(S,*)$-rooted spanning forest of $G$, if $e \in T$.
\begin{align*}
\eqref{eq:1} &= - \sum_{F \in \forests_2} w(F) (2 - \deg^o(F,*)) \cdot \#\{T \in \trees : F = T \setminus e \text{ for some } e \in T(s'),\, \delta(e;v,s') = 0 \} \\
& \sum_{T\in \trees} \sum_{e \in T\setminus T(S^*)} \one(F = T \setminus e)  \\
...
\begin{align*}
	\eqref{eq:1} &= - \sum_{F \in \forests_2} w(F) (2 - \deg^o(F,*))  \sum_{e \in \partial F(*)} \one( \delta(e; v, F(*)) = 1)  \\
...
Thus
\begin{align*}
	\eqref{eq:1} &= - \sum_{F \in \forests_2} w(F) (2 - \deg^o(F,*))  (1)  \\
	&\qquad +  \sum_{F \in \forests_2} w(F) (2 - \deg^o(F,*)) (\deg^o(F,*) - 1) \\
	&= - \!\sum_{F \in \forests_2} w(F) (2 - \deg^o(F,*))^2 .
\end{align*}
as desired.
\end{proof}
